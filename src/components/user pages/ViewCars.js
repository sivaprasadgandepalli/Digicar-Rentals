            ...
            <div>
                ...
                <section className='px-10 py-10'>
                    <div className='' id='main'>
                        {cars.map((car) => {
                            return (
                                <article className='bg-[#282828] transition ease-in-out delay-150 rounded'>
                                    <div className='overflow-hidden p-1 w-full h-56'>
                                        <img src={car.car_img} alt={car.car_name} className='relative w-full h-full transition ease-in-out delay-200 hover:opacity-30 transition-all' />
                                    </div>
                                    <div className='p-3 text-justify space-y-3 text-white'>
